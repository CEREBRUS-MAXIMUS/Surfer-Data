  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row dark:border-white/5">
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        &copy; Copyright Surfer Protocol {new Date().getFullYear()}. All rights reserved.
      </p>
      <div className="flex gap-4">
        <SocialLink href="https://x.com/surferprotocol" target="_blank" icon={XIcon}>
          Follow us on X
        </SocialLink>
        <SocialLink href="https://github.com/surfer-org" target="_blank" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
        <SocialLink href="https://discord.gg/Tjg7pjcFNP" target="_blank" icon={DiscordIcon}>
